...
<template>
  <div v-if="gameStore.isJoinServerTrayVisible && gameStore.isAutomatic"
    ...
    <div 
      class="bg-white/80 backdrop-blur-md p-3 rounded-l-30px shadow-lg border border-gray-200 flex items-center gap-2 cursor-pointer hover:bg-white/90 transition-all duration-300"
      @click="handleRestore"
    >
